    ...
    setTimeout(() => {
      ...
      if (elements.length > 0) {
        for (let elem of elements) {
          const { circles, circle_0, circle_1, circle_2, circle_3, delta } =
            elem;
          ...
          circle_0.style.transform = `translate(${-50 + delta.X * c0}%,${
            -50 + delta.Y * c0
          }%)`;
          circle_1.style.transform = `translate(${-50 + delta.X * c1}%,${
            -50 + delta.Y * c1
          }%)`;
          circle_2.style.transform = `translate(${-50 + delta.X * c2}%,${
            -50 + delta.Y * c2
          }%)`;
          circle_3.style.transform = `translate(${-50 + delta.X * c3}%,${
            -50 + delta.Y * c3
          }%)`;
        }
      }
